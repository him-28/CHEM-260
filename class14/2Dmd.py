...
##        self.md_anlysis = 1
    ...
    def setup(self,n,BoxL,PBC):
        ...
        jg = random.sample(xrange(ngrid2),ngrid2)
...
def write_gro_file_data(filename,md):
    f = open(filename,'w')
    print >> f,"2DMD Simulation, t=%f"%(md.time)
    print >> f,"%5d"%(md.number_atoms)
    for x in range(md.number_atoms):
        print >>f,"%5d%5s%5s%5d%8.3f%8.3f%8.3f%8.4f%8.4f%8.4f%8s%2d"%(0,"None",md.atoms[x].name,x,
                                                                      md.atoms[x].atom.x,
                                                                      md.atoms[x].atom.y,
                                                                      0.0,
                                                                      md.atoms[x].atom.vx,
                                                                      ...
                                                                      md.atoms[x].color,
                                                                      md.atoms[x].trace)
    print >> f,"%10.5f%10.5f%10.5f"%(md.BoxL,0.0,0.0)
    f.close()
